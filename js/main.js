...
let breadOrder = prompt('What kind of bread would you like? (white, wheat, sourdough, or flat),', 'wheat');
...
let condimentsOrder = prompt('What kind of comdiments woudl you like? (Seperate multiple condiments with a comma.)');
